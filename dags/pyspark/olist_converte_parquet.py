...
if __name__ == "__main__":
    ...
    df_customers.write.mode("overwrite").format("parquet").save(parquet_path + "/customers.parquet")
    df_orders.write.mode("overwrite").format("parquet").save(parquet_path + "/orders.parquet")
    df_order_items.write.mode("overwrite").format("parquet").save(parquet_path + "/items.parquet")
    df_payments.write.mode("overwrite").format("parquet").save(parquet_path + "/payments.parquet")
    df_products.write.mode("overwrite").format("parquet").save(parquet_path + "/products.parquet")
    df_sellers.write.mode("overwrite").format("parquet").save(parquet_path + "/sellers.parquet")
    df_product_category.write.mode("overwrite").format("parquet").save(parquet_path + "/products_cat.parquet")
    df_orders_reviews.write.mode("overwrite").format("parquet").save(parquet_path + "/orders_reviews.parquet")
